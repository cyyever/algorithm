...
TEST_CASE("flow network") {
  cyy::algorithm::minimum_cost_flow_network<
      std::string, int>::capacity_and_cost_fun_type capacity_and_cost{
      ...
      {{"x", "v"}, {3, 7, -1}}, {{"v", "s"}, {0, 7, 1}},
      {{"w", "s"}, {0, 5, -1}}, {{"w", "v"}, {-2, 2, -1}}};
  std::unordered_map<std::string, int> demand{{"s", 0}, {"t", 0}, {"u", 0},
                                              {"v", 0}, {"w", 0}, {"x", 0}};

  cyy::algorithm::minimum_cost_flow_network<std::string, int> network(
